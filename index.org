...
# +BEGIN_CENTER
Everything should be made as simple as possible,but not any simpler -- Albert Einstein && 正经话只用图表和代码说的程序媛
# +END_CENTER
-----
* Git
...
* 读书列表
 ...
 | *序号* | *书名* | *阅读时间* | *简评* |
 |  1     |  黑客与画家 |  20160528  | 看了两章，不愧是硅谷之父，还是等看完了再决定拜不拜神 |
